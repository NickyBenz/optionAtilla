...
class Ui_optionAtillaWindow(object):
    def setupUi(self, optionAtillaWindow):
        ...
        optionAtillaWindow.resize(1245, 879)
...
"color: rgb(0, 0, 0);")
        ...
        self.spinBoxSpread.setProperty("value", 5)
        ...
        self.tableAccount = QtWidgets.QTableView(parent=self.centralwidget)
        self.tableAccount.setGeometry(QtCore.QRect(1040, 0, 201, 251))
        self.tableAccount.setAutoFillBackground(True)
        self.tableAccount.setStyleSheet("")
        ...
        self.pushButtonExecute.setGeometry(QtCore.QRect(160, 820, 151, 31))
        self.pushButtonExecute.setStyleSheet("background-color: rgb(100, 100, 100);")
        self.pushButtonExecute.setObjectName("pushButtonExecute")
        self.pushButtonLiquidate = QtWidgets.QPushButton(parent=self.centralwidget)
        self.pushButtonLiquidate.setGeometry(QtCore.QRect(700, 820, 141, 31))
        self.pushButtonLiquidate.setStyleSheet("background-color: rgb(100, 100, 100);")
        self.pushButtonLiquidate.setObjectName("pushButtonLiquidate")
        self.tableSelections = QtWidgets.QTableView(parent=self.centralwidget)
        self.tableSelections.setGeometry(QtCore.QRect(10, 260, 581, 411))
        self.tableSelections.setAutoFillBackground(True)
        self.tableSelections.setStyleSheet("")
        self.tableSelections.setObjectName("tableSelections")
        self.pushButtonDisplay = QtWidgets.QPushButton(parent=self.centralwidget)
        self.pushButtonDisplay.setGeometry(QtCore.QRect(10, 820, 131, 31))
        ...
        self.tableSelections_2 = QtWidgets.QTableView(parent=self.centralwidget)
        self.tableSelections_2.setGeometry(QtCore.QRect(600, 260, 641, 411))
        self.tableSelections_2.setAutoFillBackground(True)
        self.tableSelections_2.setStyleSheet("")
        self.tableSelections_2.setObjectName("tableSelections_2")
        self.pushButtonClose = QtWidgets.QPushButton(parent=self.centralwidget)
        self.pushButtonClose.setGeometry(QtCore.QRect(1050, 820, 81, 31))
        ...
        self.tableViewCloseOrders = QtWidgets.QTableView(parent=self.centralwidget)
        self.tableViewCloseOrders.setGeometry(QtCore.QRect(600, 680, 641, 121))
        self.tableViewCloseOrders.setObjectName("tableViewCloseOrders")
        self.pushButtonClearSelectionOrders = QtWidgets.QPushButton(parent=self.centralwidget)
        self.pushButtonClearSelectionOrders.setGeometry(QtCore.QRect(320, 820, 151, 31))
        self.pushButtonClearSelectionOrders.setStyleSheet("background-color: rgb(100, 100, 100);")
        self.pushButtonClearSelectionOrders.setObjectName("pushButtonClearSelectionOrders")
        self.pushButtonCancelLiquidateOrders = QtWidgets.QPushButton(parent=self.centralwidget)
        self.pushButtonCancelLiquidateOrders.setGeometry(QtCore.QRect(870, 820, 141, 31))
        self.pushButtonCancelLiquidateOrders.setStyleSheet("background-color: rgb(100, 100, 100);")
        self.pushButtonCancelLiquidateOrders.setObjectName("pushButtonCancelLiquidateOrders")
...
"No. of Expiries"))
        ...
        self.pushButtonExecute.setText(_translate("optionAtillaWindow", "Build Selected Positions"))
        self.pushButtonLiquidate.setText(_translate("optionAtillaWindow", "Close All At Market Price"))
        ...
        self.pushButtonClearSelectionOrders.setText(_translate("optionAtillaWindow", "Cancel All Orders"))
        self.pushButtonCancelLiquidateOrders.setText(_translate("optionAtillaWindow", "Cancel All Orders"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    optionAtillaWindow = QtWidgets.QMainWindow()
    ui = Ui_optionAtillaWindow()
    ui.setupUi(optionAtillaWindow)
    optionAtillaWindow.show()
    sys.exit(app.exec())

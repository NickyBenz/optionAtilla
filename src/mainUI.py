...
"color: rgb(0, 0, 0);")
        ...
        self.pushButtonTrade.setGeometry(QtCore.QRect(190, 820, 91, 31))
        ...
        self.pushButtonLiquidate.setGeometry(QtCore.QRect(760, 820, 101, 31))
        ...
        self.pushButtonDisplay.setGeometry(QtCore.QRect(80, 820, 101, 31))
        ...
        self.pushButtonClearSelection.setGeometry(QtCore.QRect(290, 820, 101, 31))
        ...
        self.pushButtonCancelOrders = QtWidgets.QPushButton(parent=self.centralwidget)
        self.pushButtonCancelOrders.setGeometry(QtCore.QRect(400, 820, 101, 31))
        self.pushButtonCancelOrders.setStyleSheet("background-color: rgb(100, 100, 100);")
        self.pushButtonCancelOrders.setObjectName("pushButtonCancelOrders")
        self.pushButtonClearTrades = QtWidgets.QPushButton(parent=self.centralwidget)
        self.pushButtonClearTrades.setGeometry(QtCore.QRect(880, 820, 101, 31))
...
"No. of Expiries"))
        ...
        self.pushButtonTrade.setText(_translate("optionAtillaWindow", "Trade"))
        self.pushButtonLiquidate.setText(_translate("optionAtillaWindow", "Liquidate"))
        ...
        self.pushButtonCancelOrders.setText(_translate("optionAtillaWindow", "Cancel Open"))
